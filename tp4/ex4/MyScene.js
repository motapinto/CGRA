...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.quad, this.tangram, this.cube_quad];
        this.objectIDs = { 'Quad': 0 , 'Tangram': 1, 'MyUnitQuadCube': 2};
...
/*
tex = CGFTextture(scene, "path") - ja faz load da imagem para aqui e aplica
CGFApp.loadTexture(tex)
CGFapp.setTexture("url") - implica um load
